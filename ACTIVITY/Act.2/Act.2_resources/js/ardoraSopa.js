...
fillingGame();
var canvas = document.getElementById("ardoraActBoard");var context = canvas.getContext("2d");context.font = "14px "+fActi;
pB=setInterval("paintBoard()",2000);
}
...
ctx.fillStyle = "rgba(0,0,255,1)";ctx.quadraticCurveTo(x+w/3,y-w/3, x+w/2,y);
